        ...
        .then(data => {
            ...
            if (data._id === localStorage.getItem('uname')) {
                ...
                if (localStorage.getItem('permissions') === "1") {
                    ...
                    <div class="usr-header">
                    <h2 class="uname">${data._id}</h2>
                    <button class="button dm-btn" onclick="openmdusr('${data._id}');" aria-label="moderate user">
                    ...
                    <button class="button dm-btn" onclick="parent.opendm('${data._id}');" aria-label="dm user">
